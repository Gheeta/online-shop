       ...
       <Menu
        ...
        >
            { getdata.length?
                                           ...
                                           <tr>
                                              ...
                                              <td>
                                                    <NavLink to={`/cart/${e.id}`}  onClick={handleClose}>
                                                        <img src={e.imgdata} style={{width:"5rem", height:"5rem", borderRadius:"5px"}} alt=" "/>
                                                    </NavLink>
                                              </td>
                                              ...
                                              <td>
                                                  ...
                                                  <p style={{color:"red",fontSize:20,cursor:"pointer"}} onClick={()=>dlt(e.id)}>
                                                      <i className='fa-solid fa-trash-can smalltrash'></i>
                                                  </p>
                                              </td>
                ...
                :
                <div className='card_details d-flex justify-content-center align-items-center' style={{width:"18rem",
